...
Susan Yang and Travis Xie
Assignment 2, part 2, CSE415, Winter 2021
...
This implementation does reconsider a state once it has
...
h = Problem.h   # heuristic value
# The value g(s) represents the cost along the best path found so far
# from the initial state to state s.
g = {}  # a dictinonary that contains state as a key, and corresponding value of 
        # shortest path from initial state
